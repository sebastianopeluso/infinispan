...
@Listener
public class DataPlacementManagerV2 {

   private static final Log log = LogFactory.getLog(DataPlacementManagerV2.class);
   ...
   private RemoteAccessesManagerV2 remoteAccessesManager;
   private ObjectPlacementManagerV2 objectPlacementManager;
   ...
   public void inject(CommandsFactory commandsFactory, DistributionManager distributionManager, RpcManager rpcManager,
      ...
      synchronized (this) {
         if (stateTransfer instanceof DistributedStateTransferManagerImpl && !roundManager.isEnabled()) {
            remoteAccessesManager = new RemoteAccessesManagerV2(distributionManager,dataContainer);
            objectPlacementManager = new ObjectPlacementManagerV2(distributionManager,configuration.clustering().hash().hash());
