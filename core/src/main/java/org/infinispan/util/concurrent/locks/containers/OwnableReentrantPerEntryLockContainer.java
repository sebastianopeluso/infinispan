...
public class OwnableReentrantPerEntryLockContainer extends AbstractPerEntryLockContainer<OwnableRefCountingReentrantLock> {
   ...
   @Override
   public OwnableRefCountingReentrantLock getExclusiveLock(Object key) {
      return getLockFromMap(key);
   }

   @Override
   public OwnableRefCountingReentrantLock getShareLock(Object key) {
   ...
   @Override
   protected void unlockExclusive(OwnableRefCountingReentrantLock l, Object owner) {
      l.unlock(owner);
   }
   ...
   @Override
   protected void unlockShare(OwnableRefCountingReentrantLock toRelease, Object ctx) {
      throw new UnsupportedOperationException();
   }

   private OwnableRefCountingReentrantLock getLockFromMap(Object key) {
