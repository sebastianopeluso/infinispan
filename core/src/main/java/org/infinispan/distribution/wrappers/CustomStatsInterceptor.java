...
public final class CustomStatsInterceptor extends BaseCustomInterceptor {
   ...
   public Object visitPutKeyValueCommand(InvocationContext ctx, PutKeyValueCommand command) throws Throwable {
      ...
      if (ctx.isInTxScope()) {
         ...
         TransactionsStatisticsRegistry.addNTBCValue(initTime);
         try {
         ...
         if (isRemote(command.getKey())) {
            TransactionsStatisticsRegistry.addValue(IspnStats.REMOTE_PUT_EXECUTION, System.nanoTime() - initTime);
   ...
   public Object visitGetKeyValueCommand(InvocationContext ctx, GetKeyValueCommand command) throws Throwable {
      ...
      if (isTx) {
         ...
         this.initStatsIfNecessary(ctx);
         TransactionsStatisticsRegistry.notifyRead();
         long currCpuTime = 0;
         ...
         if (isRemoteKey) {
            TransactionsStatisticsRegistry.incrementValue(IspnStats.NUM_LOCAL_REMOTE_GET);
            TransactionsStatisticsRegistry.addValue(IspnStats.LOCAL_REMOTE_GET_R, lastTimeOp - currTimeForAllGetCommand);
            if (sampleServiceTimes)
               TransactionsStatisticsRegistry.addValue(IspnStats.LOCAL_REMOTE_GET_S, threadMXBean.getCurrentThreadCpuTime() - currCpuTime);
         }
   ...
   public double getAvgNumPutsBySuccessfulLocalTx() {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.PUTS_PER_LOCAL_TX));
   }
   ...
   public long getAvgNumAsyncSentCommitMsgs() {
      return handleLong((Long) (TransactionsStatisticsRegistry.getAttribute((IspnStats.SENT_ASYNC_COMMIT))));
   }
   ...
   public long getAvgNumSyncSentCommitMsgs() {
      return handleLong((Long) (TransactionsStatisticsRegistry.getAttribute((IspnStats.SENT_SYNC_COMMIT))));
   }
   ...
   public long getAvgLocalSuccessfulLockHoldTime() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.SUX_LOCK_HOLD_TIME));
   }
   ...
   public long getAvgLocalLocalAbortLockHoldTime() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.LOCAL_ABORT_LOCK_HOLD_TIME));
   }
   ...
   public long getAvgLocalRemoteAbortLockHoldTime() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.REMOTE_ABORT_LOCK_HOLD_TIME));
   }
   ...
   public long getAvgRollbackCommandSize() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.ROLLBACK_COMMAND_SIZE));
   }
   ...
   public long getAvgClusteredGetCommandReplySize() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.REMOTE_REMOTE_GET_REPLY_SIZE));
   }
   ...
   public double getRemotelyDeadXact() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_REMOTELY_ABORTED));
   }

   @ManagedAttribute(description = "Number of early aborts",
           displayName = "Number of early aborts")
   public double getNumEarlyAborts() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_EARLY_ABORTS));
   }
   ...
   public double getNumLocalPrepareAborts() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_LOCALPREPARE_ABORTS));
   }
   ...
   public double getUpdateXactToPrepare() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_UPDATE_TX_GOT_TO_PREPARE));
   }
   ...
   public double getAvgRemoteGetsPerWrTransaction() {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_SUCCESSFUL_REMOTE_GETS_WR_TX));
   }
   ...
   public double getAvgRemoteGetsPerROTransaction() {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_SUCCESSFUL_REMOTE_GETS_RO_TX));
   }

   @ManagedAttribute(description = "Average cost of a remote get",
           displayName = "Remote get cost")
   public long getRemoteGetResponseTime() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.LOCAL_REMOTE_GET_R));
   }
   ...
   public double getAvgPutsPerWrTransaction() {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_SUCCESSFUL_PUTS_WR_TX));
   }
   ...
   public double getAvgRemotePutsPerWrTransaction() {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_SUCCESSFUL_REMOTE_PUTS_WR_TX));
   }
   ...
   public long getNumberOfRemoteGets() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_LOCAL_REMOTE_GET));
   }
   ...
   public long getTerminationCost() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.TERMINATION_COST));
   }
   ...
   public long getRemoteGetServiceTime() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.LOCAL_REMOTE_GET_S));
   }
   ...
   public double getNumOwnedRdItemsInLocalPrepare() {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_OWNED_RD_ITEMS_IN_LOCAL_PREPARE));
   }
   ...
   public double getNumOwnedWrItemsInLocalPrepare() {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_OWNED_WR_ITEMS_IN_LOCAL_PREPARE));
   }
   ...
   public double getNumOwnedRdItemsInRemotePrepare() {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_OWNED_RD_ITEMS_IN_REMOTE_PREPARE));
   }
   ...
   public double getNumOwnedWrItemsInRemotePrepare() {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_OWNED_WR_ITEMS_IN_REMOTE_PREPARE));
   }
   ...
   public double getNumReadsBeforeWrite() {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.FIRST_WRITE_INDEX));
   }
   ...
   public double getGMUClusteredGetCommandWaitingTime() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.REMOTE_REMOTE_GET_WAITING_TIME));
   }
   ...
   public double getGMUClusteredGetCommandResponseTime() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.REMOTE_REMOTE_GET_R));
   }
   ...
   public double getGMUClusteredGetCommandServiceTime() {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.REMOTE_REMOTE_GET_S));
   }
   ...
   public double getAvgNumPutsBySuccessfulLocalTxParam(@Parameter(name = "Transaction Class") String transactionalClass) {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.PUTS_PER_LOCAL_TX, transactionalClass));
   }
  ...
  public long getAvgCommitTimeParam(@Parameter(name = "Transaction Class") String transactionalClass) {
   ...
   public double getAvgRemoteGetsPerWrTransactionParam(@Parameter(name = "Transaction Class") String transactionalClass) {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_SUCCESSFUL_REMOTE_GETS_WR_TX, transactionalClass));
   }
   ...
   public double getAvgRemoteGetsPerROTransactionParam(@Parameter(name = "Transaction Class") String transactionalClass) {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_SUCCESSFUL_REMOTE_GETS_RO_TX, transactionalClass));
   }
   ...
   public long getRemoteGetExecutionTimeParam(@Parameter(name = "Transaction Class") String transactionalClass) {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.LOCAL_REMOTE_GET_R, transactionalClass));
   }
   ...
   public double getAvgPutsPerWrTransactionParam(@Parameter(name = "Transaction Class") String transactionalClass) {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_SUCCESSFUL_PUTS_WR_TX, transactionalClass));
   }
   ...
   public double getAvgRemotePutsPerWrTransactionParam(@Parameter(name = "Transaction Class") String transactionalClass) {
      return handleDouble((Double) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_SUCCESSFUL_REMOTE_PUTS_WR_TX, transactionalClass));
   }
   ...
   public long getNumberOfRemoteGetsParam(@Parameter(name = "Transaction Class") String transactionalClass) {
      return handleLong((Long) TransactionsStatisticsRegistry.getAttribute(IspnStats.NUM_LOCAL_REMOTE_GET, transactionalClass));
   }
  ...
  */
   ...
   public long getNumAbortedXacts() {
      return handleLong((Long) (TransactionsStatisticsRegistry.getAttribute((IspnStats.NUM_ABORTED_WR_TX))));
   }
   ...
   public long getNumWaitedRemoteGets() {
      return handleLong((Long) (TransactionsStatisticsRegistry.getAttribute((IspnStats.NUM_WAITS_REMOTE_REMOTE_GETS))));
   }
   ...
   public long getNumWaitedLocalCommits() {
      return handleLong((Long) (TransactionsStatisticsRegistry.getAttribute((IspnStats.NUM_WAITS_IN_COMMIT_QUEUE))));
   }
   ...
   public long getNumWaitedRemoteCommits() {
      return handleLong((Long) (TransactionsStatisticsRegistry.getAttribute((IspnStats.NUM_WAITS_IN_REMOTE_COMMIT_QUEUE))));
   }
   ...
   public long getNumLocalLocalLockContentions() {
      return handleLong((Long) (TransactionsStatisticsRegistry.getAttribute((IspnStats.LOCK_CONTENTION_TO_LOCAL))));
   }
   ...
   public long getNumLocalRemoteLockContentions() {
      return handleLong((Long) (TransactionsStatisticsRegistry.getAttribute((IspnStats.LOCK_CONTENTION_TO_REMOTE))));
   }
   ...
   public long getNumRemoteLocalLockContentions() {
      return handleLong((Long) (TransactionsStatisticsRegistry.getAttribute((IspnStats.REMOTE_LOCK_CONTENTION_TO_LOCAL))));
   }
   ...
   public long getNumRemoteRemoteLockContentions() {
      return handleLong((Long) (TransactionsStatisticsRegistry.getAttribute((IspnStats.REMOTE_LOCK_CONTENTION_TO_REMOTE))));
   }
   ...
   private void handleRollbackCommand(long initTime, long initCpuTime, TxInvocationContext ctx) {
      if (TransactionsStatisticsRegistry.hasStatisticCollector()) {
         ...
         if (ctx.isOriginLocal()) {
            if (TransactionsStatisticsRegistry.isPrepareSent() || ctx.getCacheTransaction().wasPrepareSent()) {
               ...
               if (TransactionsStatisticsRegistry.stillLocalExecution()) {
                  TransactionsStatisticsRegistry.incrementValue(IspnStats.NUM_EARLY_ABORTS);
               } else {
                  TransactionsStatisticsRegistry.incrementValue(IspnStats.NUM_LOCALPREPARE_ABORTS);
               }
   ...
   private void handleCommitCommand(long initTime, long initCpuTime, TxInvocationContext ctx) {
      ...
      if (TransactionsStatisticsRegistry.hasStatisticCollector()) {
         ...
         if (ctx.isOriginLocal() && TransactionsStatisticsRegistry.isReadOnly()) {
