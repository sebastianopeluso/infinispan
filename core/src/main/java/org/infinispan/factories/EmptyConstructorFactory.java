 ...
 * @since 4.0
 */
@DefaultFactoryFor(classes = {InboundInvocationHandler.class, RemoteCommandsFactory.class, TransactionFactory.class, L1Manager.class, ExternalizerTable.class, CommitLog.class, CommitQueue.class })
@Scope(Scopes.GLOBAL)
