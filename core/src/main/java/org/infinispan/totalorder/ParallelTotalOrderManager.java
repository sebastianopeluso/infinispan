...
public class ParallelTotalOrderManager extends BaseTotalOrderManager {
   ...
   public final void validateTransaction(PrepareCommand prepareCommand, TxInvocationContext ctx,
      ...
      MultiThreadValidation mtv = buildMultiThreadValidation(prepareCommand, ctx, invoker, remoteTransaction);
   ...
   protected MultiThreadValidation buildMultiThreadValidation(PrepareCommand prepareCommand, TxInvocationContext txInvocationContext,
                                    CommandInterceptor invoker, TotalOrderRemoteTransaction remoteTransaction) {
      return new MultiThreadValidation(prepareCommand, txInvocationContext, invoker, remoteTransaction);
   }

   /**
    * This class is used to validate transaction in repeatable read with write skew check
    */
   protected class MultiThreadValidation implements Runnable {
